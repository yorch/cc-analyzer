...
Sources: [src/cli/index.ts:L79-L107](https://github.com/yorch/cc-analyzer/blob/345633c/src/cli/index.ts#L79-L107) [src/core/session-markdown.ts:L1-L40](https://github.com/yorch/cc-analyzer/blob/345633c/src/core/session-markdown.ts#L1-L40) [src/core/session-markdown.ts:L46-L180](https://github.com/yorch/cc-analyzer/blob/345633c/src/core/session-markdown.ts#L46-L180)(<https://github.com/yorch/cc-analyzer/blob/51ccd4e/src/cli/index.ts#L79-L107>)
...
| `--json` | `analyze`, `doctor`, `stats`, `audit`, `insights`, `report` | Emit the raw core object as JSON instead of a rendered report; also suppresses the passive update notice. For `analyze --json --redact` the JSON payload rolls `title`/`projectPath` to `[redacted]` and `filesTouched`/`bashCommands` to counts and caps transcript at `600×2000` |
