...
| `project-labels` | [src/core/project-labels.ts](https://github.com/yorch/cc-analyzer/blob/51ccd4e/src/core/project-labels.ts) | Bun-free: project identity — decode/display an id, and resolve one a human typed |
